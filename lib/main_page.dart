...
double bottom(BuildContext context) =>
    MediaQuery
        .of(context)
        .size
        .height - dotsTopMargin(context) - 8;
    ...
    return Positioned(
      ...
      child: Consumer<PageOffsetNotifier>(
        ...
        child: FlatButton(
          ...
          onPressed: () {
            // Provider.of<MapAnimationNotifier>(context, listen: false).forward();
